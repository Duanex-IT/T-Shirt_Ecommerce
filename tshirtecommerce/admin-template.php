...
<head>
	...
	<title><?php echo setValue($settings, 'site_name', '–едактор продуктов'); ?></title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=1, minimum-scale=0.5, maximum-scale=1.0"/>
	<meta content="<?php echo setValue($settings, 'meta_description', '–едактор продуктов'); ?>" name="description" />
	<meta content="<?php echo setValue($settings, 'meta_keywords', '–едактор продуктов'); ?>" name="keywords" />
