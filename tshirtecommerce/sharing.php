...
<head>
    ...
    <meta content="<?php echo setValue($settings, 'meta_description', 'Редактор продуктов'); ?>" name="description" />
	<meta content="<?php echo setValue($settings, 'meta_keywords', 'Редактор продуктов'); ?>" name="keywords" />
    <title><?php echo setValue($settings, 'site_name', 'Редактор продуктов'); ?></title>
	
	<meta property="og:url" content="<?php echo $url; ?>" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="<?php echo setValue($settings, 'site_name', 'Редактор продуктов'); ?>" />
    <meta property="og:description" content="<?php echo setValue($settings, 'meta_description', 'Редактор продуктов'); ?>" />
